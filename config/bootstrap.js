...
module.exports = function(next) {
    ...
    Contacts.replace("co_id=1", [], data, (errsql, row_co)=> {
        ...
        async.eachSeries(tabNum, (num, nextNum)=> {
            let co_type = 'user' ;
            if (num>10) co_type = 'contact' ;
            Contacts.replace({co_id:num}, [], {co_id:num, co_name:_.capitalize(co_type), co_firstname:num, co_email:'contact'+num+'@email.com', co_login:'contact'+num+'@email.com', co_password:'xxxxx', co_type:co_type, co_active:1, co_geo_lat:'43.709464', co_geo_lng:'7.258434', co_address1:'5 rue Castel', co_address2:'', co_zip:'06000', co_city:'Nice', co_admin:0, co_apikey:num, co_apisecret:num, deleted:0}, (errsql, row_co)=> {
                nextNum() ;
            }) ;
        }, ()=> {
            next() ;
